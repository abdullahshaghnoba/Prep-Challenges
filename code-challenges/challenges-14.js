...
const replaceWords = (str) => {
  ...
  let arr = str.split(' ');
    ...
    if (indexOfI != -1) { arr.splice(indexOfI, 1, 'We') };
    if (indexOfAm != -1) { arr.splice(indexOfAm, 1, 'are') };
    if (indexOfWas != -1) { arr.splice(indexOfWas, 1, 'were') };
  let newArr = arr.join(" ");
    return newArr;
// return str.replaceAll("I","We").replaceAll("am","are").replaceAll("was","were");
}
// -------------------------------------------------------------------------------------------------------
